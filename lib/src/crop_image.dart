...
Future<MaskForCameraViewResult> _oldCropHalfImage(
  String ocrType,
  Image image,
  MaskForCameraViewInsideLine insideLine,
) async {
  ...
  if (ocrType == 'greenIdCard') {
    ...
    Image thirdCroppedImage = copyCrop(
      image,
      x: x.toInt(),
      y: y.toInt(),
      width: w.toInt(),
    ...
    Image fourCroppedImage = copyCrop(
      image,
      x: x.toInt(),
      y: y.toInt(),
      width: w.toInt(),
    ...
    Image fiveCroppedImage = copyCrop(
      image,
      x: x.toInt(),
      y: y.toInt(),
      width: w.toInt(),
    ...
    Image sixCroppedImage = copyCrop(
      image,
      x: x.toInt(),
      y: y.toInt(),
      width: w.toInt(),
