            ...
            child: !_cameraController!.value.isInitialized
                ...
                : Column(
                    children: [
                      ...
                      Expanded(child: Container(color: widget.bottomBarColor)),
                    ],
                  ),
          ),
          Positioned(
            ...
            child: Center(
              child: DottedBorder(
                options: RoundedRectDottedBorderOptions(
                  ...
                  radius: Radius.circular(widget.boxBorderRadius),
                ),
                child: Container(
                  decoration: BoxDecoration(
...
class _IsCropping extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return isRunning && widget.boxWidth >= 50.0 && widget.boxHeight >= 50.0
        ? const Center(child: CupertinoActivityIndicator(radius: 12.8))
        : Container();
  }
}
